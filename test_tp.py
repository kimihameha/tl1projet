...
test_pointfloat    = "tp.pointfloat" # à remplacer par "tp.pointfloat"
test_exponent      = "tp.exponent" # à remplacer par "tp.exponent"
test_exponentfloat = "tp.exponentfloat" # à remplacer par "tp.exponentfloat"
test_number        = "tp.number" # à remplacer par "tp.number"
